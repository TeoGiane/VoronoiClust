#' @name likelihood_params
#' @title Likelihood Parameters
#' @description A list specifying the parameters for the likelihood model.
#'
#' @section Quadratic Likelihood (`type = "quadratic"`):
#' For the quadratic likelihood, which is the default, the list should contain the following items:
#' \itemize{
#'   \item `type`: A string, must be `"quadratic"`.
#'   \item `shape_within`: Shape parameter for the Gamma distribution of within-cluster distances.
...
#'   \item `shape_between`: Shape parameter for the Gamma distribution of between-cluster distances.
#'   \item `prior_shape_between`: Shape parameter for the Gamma prior on the rate of between-cluster distances.
